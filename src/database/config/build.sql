...
-- Create Replys Table;
CREATE TABLE replys (id SERIAL PRIMARY KEY,reply_content TEXT NOT NULL, user_id INT NOT NULL, FOREIGN KEY (user_id) REFERENCES users(id), tweet_id INT NOT NULL, FOREIGN KEY (tweet_id) REFERENCES tweets(id), created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
